...
Most RPG characters to date were relatively simple and predictable. [Locke](https://finalfantasy.fandom.com/wiki/Locke_Cole) *(FF3 US)* was a rogue with some wit but has very little depth. [Chrono](https://chrono.fandom.com/wiki/Crono) from Chrono Trigger moves through the world without much to say. Dialogue is primarily driven by other characters, most of whom are quite predictable and thin.
...
{{ spotifyTrackEmbed("18sDWMHFfgDOh1zMrFJt1C", "Aerith's Theme") }}
